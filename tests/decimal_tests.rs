...
mod maths {
    ...
    fn test_powd() {
        let test_cases = &[
            ...
            // ~= 611.0451043224257
            ("1234.5678", "0.9012", "611.04510428561357675577986292"),
            ("-2", "0.5", "-1.4142135570048917090885260834"),
            // ~= -1.1193003023312942
            ("-2.5", "0.123", "-1.1193002994383985239135362087"),
            // ~= 0.0003493091
            (
                "0.0000000000000000000000000001",
                "0.1234567890123456789012345678",
                "0.0003533642785253753219626202",
            ),
    ...
    fn test_exp_with_tolerance() {
        let test_cases = &[
            ...
            // e^10 ~= 22026.465794806703
            ("10", "0.02", "22026.460266271287808109770781"),
            // e^11 ~= 59874.14171519778
